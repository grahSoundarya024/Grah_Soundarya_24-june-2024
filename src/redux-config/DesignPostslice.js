...
import axios from "axios";
 ...
 export const UploadDesign = createAsyncThunk("DesignPostslice/UploadDesign",async({design_id: id,image_url,description})=>{
    ...
    try{
let response = await axios.post("http://localhost:3001/design/uploadImages",{design_id: id,image_url,description})
...
const slice = createSlice({
    ...
    extraReducers:(builder)=>{
        builder.addCase(UploadDesign.pending,(state,action)=>{
