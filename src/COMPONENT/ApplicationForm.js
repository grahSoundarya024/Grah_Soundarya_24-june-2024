...
//                 {/* <button style={{backgroundColor:"#edbe66", color:"black", borderRadius:"5px", border:"none"}} onClick={checkoutHandler}>Submit</button> */}
//                 <button
//                   style={{
//                     backgroundColor: "#edbe66",
//                     color: "black",
...
const ApplicationForm = () => {
  ...
  const [errors, setErrors] = useState({});
  const [subId, setSubId] = useState(null); // Add state for sub_id
  ...
  const handleSubmit = async (e) => {
    ...
    if (validate()) {
      ...
      // alert("Form submitted");
        // checkoutHandler(999);
        checkoutHandler(999,response.data.subscription.sub_id);
        setSubId(response.data.subscription.sub_id); // Store sub_id in state
  ...
  // const checkoutHandler = async (amount) => {
    const checkoutHandler = async (amount,sub_id) => {
          ...
          try {
            ...
            const paymentVerificationResponse = await axios.post(
...

              {
                ...
                razorpay_signature: response.razorpay_signature,
                amount: amount,
                sub_id: sub_id // Include sub_id in the payment verification request
            ...
            if (paymentVerificationResponse.data.success) {
              ...
              //   formData
              // ); //on demand comment
              alert("Subscription Taken Successfully");
              // console.log("PlaceOrder API response:", myOrder.data);//od
...
//                   />
//                   {errors.professional_name && (
//                     <div className="text-danger">{errors.professional_name}</div>
//                   )}
//                 </div>
//                 <div className="mb-3">
//                   <input
...
//                   />
//                   {errors.profileImg_URL && (
//                     <div className="text-danger">{errors.profileImg_URL}</div>
//                   )}
//                 </div>
//                 <div className="row g-3">
//                   <div className="col">
          ...
          <div className="row">
            <div className="col-md-12 ">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className=" d-flex justify-content-center mt-4 col text-center mt-3">
                 <button className="btn btn-secondary me-5">Cancel</button>

                  <button 
        style={{backgroundColor: "#D89619",color:'white',border:'#D89619'}}
                    type="submit"
