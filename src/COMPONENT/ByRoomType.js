...
const ByRoomType = () => {
  ...
  const { AllDesignList, isLoading, error } = useSelector(
    (store) => store.AllDesigns
  );
  ...
  useEffect(() => {
    console.log(AllDesignList, isLoading, error);
                    ...
                    >
                      <Tooltip title="Favourite" arrow placement="top">
                        <Rating
                          ...
                          onClick={() =>
                            moveToFavDesignPost(design.designImg_id[imgIndex])
                          }
                        />
                      </Tooltip>
                      <span className="tooltip" style={styles.tooltip}></span>
                    </div>
                    <div className="circle-hover" style={styles.circleHover}>
