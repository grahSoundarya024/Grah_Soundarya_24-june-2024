...
const Portfolio = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3001/design/viewAllRoomType")
      .then((response) => {
  ...
  const professional_id = professionalData
  ...
  // alert("professional_id",professional_id);

  const movetoByCategory = (roomType_id) => {
    // navigate(`/home/professional_id/:id/roomType_id/${roomType_id}`);
    navigate(
      `/home/professional_id/${professional_id}/roomType_id/${roomType_id}`
    );
  };
  ...
  const goToChat = () => {
    navigate("/Appp", { state: { professionalData } });
  };
  ...
  return (
    <>
      ...
      <section className="container-fluid px-0 main-section">
        <img
          src="http://localhost:3000//Slider-5-Living.jpg"
          alt="Slider-5-Living.jpg"
          width="1345px"
        />
        ...
        <div className="container mt-2">
          <div className="row">
            <div className="col-md-12 mx-auto">
              <div
                className="second-section-outer d-flex justify-content-center align-items-center overflow-hidden"
                ...
                <div className="container  mt-5">
                  <div className="row">
                    <div className="col-md-10 mx-auto">
                      <div
                        className="second-section w-80 border border p-4"
                        style={{
                          height: "450px",
                          backgroundColor: "white",
                          boxShadow: "10px 0px 20px 5px gray",
                        }}
                      >
                                ...
                                <div className="col-md-12 mx-auto">
                                  <div className="description text-center bg-white shadow-sm rounded bg-white shadow p-1 mb-2 boxShadow: 10px 0px 20px 5px gray">
                                    <p>
                                      Name :{" "}
                                      <span>
                                        {professionalData?.professional_name}
                                      </span>
                                    </p>
                                    <p>
                                      Email :{" "}
  ...
  Chat with Designer
              ...
              <div className="Option-outer">
                ...
                <button
                  onClick={() => GotoVideoget(professionalData.professional_id)}
        ...
        <div className="container mt-5">
          <div
            ...
            style={{
              position: "relative",
              background: "#F0F1F1", //border:'2px solid black'
            }}
          >
            <h1
              style={{
            ...
            {roomTypeList.map((blank, index) => (
              ...
              >
                ...
                <img
                  ...
                  onClick={() => movetoByCategory(blank.roomType_id)}
                />
                <h3
